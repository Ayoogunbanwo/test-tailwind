      ...
      <div className="w-full max-w-md px-6">
        ...
        <div className="text-center">
          ...
          <p className="mt-4 mb-6">
            Enter your phone number to receive a link to reset your password
          </p>

          {/* Phone Number Input */}
          <form action="/send-otp" method="POST" className="space-y-4">
            {/* Phone Number Input */}
            <input
              type="tel"
          ...
          <div className="text-center text-slate-600 text-sm font-normal font-['Open Sans'] leading-tight mt-4">
            Your new Code must be different from previously used Code.
          </div>
        </div>
      </div>
    </div>
